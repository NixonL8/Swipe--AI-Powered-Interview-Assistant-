...
import { ResumeUploadCard } from '@/components/ResumeUpload'
...
import {
  ...
  submitAnswer,
  submitProfileField,
} from '@/features/candidates/validate'
          ...
          <Row gutter={[24, 24]}>
            ...
            <Col xs={24} lg={10}>
              {status === 'awaiting-start' && (
                <Card>
                  <Paragraph>
                    Ready to begin? You&apos;ll face 6 questions with increasing difficulty.
                    Timers will auto-submit your answer when time is up.
                  </Paragraph>
                  <Button
                    type="primary"
              ...
              {status === 'in-progress' && currentQuestion && (
                ...
                >
                  ...
                  />
                  <Paragraph type="secondary">{currentQuestion.prompt}</Paragraph>
                  <TextArea
                    rows={6}
                    value={answer}
